...
namespace TechChallenge.CreateContact.UnitTest.Api.Dtos;
...
public class PostContactDtoTests
{
    ...
    [Theory]
    [InlineData("johndoe@example.com", "47123456789", "The Name field is required.")]
    [InlineData("johndoe@example.com", "47123456789", "The field Name must be a string with a minimum length of '3'.")]
    ...
    [InlineData("johndoe@example.com", "777744", "Phone format is invalid. Format accepted is: 99123456789 (DDD+number, without spaces and ())")]
